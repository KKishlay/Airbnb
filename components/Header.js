...
const Header = ({ placeholder }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 grid grid-cols-3 shadow-lg bg-white p-5 md:px-10">
        {/* left content */}
        <div
          className="relative flex items-center h-10 cursor-pointer my-auto"
          onClick={() => router.push("/")}
        >
          <img src="https://links.papareact.com/qd3" className="w-[80px]" />
        </div>

        {/* middle content */}
        <div className="flex items-center md:border-2 py-2  rounded-full md:shadow-lg">
          <input
            value={searchInput}
        ...
        <div className="flex space-x-4 items-center justify-end">
          <p className="hidden md:inline">Beacome a host</p>
